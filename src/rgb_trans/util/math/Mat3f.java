...
public class Mat3f {
	...
	public static Mat3f mul(Mat3f mat1, Mat3f mat2){
		return new Mat3f(
				// First Column
				Vec3f.dot(mat1.getRow(0), mat2.getCol(0)),
				Vec3f.dot(mat1.getRow(1), mat2.getCol(0)),
				Vec3f.dot(mat1.getRow(2), mat2.getCol(0)),
				// Second Column
				Vec3f.dot(mat1.getRow(0), mat2.getCol(1)),
				Vec3f.dot(mat1.getRow(1), mat2.getCol(1)),
				Vec3f.dot(mat1.getRow(2), mat2.getCol(1)),
				// Third Column
				Vec3f.dot(mat1.getRow(0), mat2.getCol(2)),
				Vec3f.dot(mat1.getRow(1), mat2.getCol(2)),
				Vec3f.dot(mat1.getRow(2), mat2.getCol(2))
				);
	}
	...
	public static Mat3f getTransformationMatrix(Vec2f translation, float rotation, float scale){
		return new Mat3f().mul(scale).rotate(rotation).translate(translation);
	}
	
	public static Mat3f getTransformationMatrix(Vec2f translation, float rotation, Vec2f scale){
		return new Mat3f().scale(scale).rotate(rotation).translate(translation);
	}
